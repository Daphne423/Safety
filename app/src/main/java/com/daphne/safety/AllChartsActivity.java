...
public class AllChartsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            if(i % 3 == 0) {
                list.add(new BarChartItem(generateDataLine(i + 1), getApplicationContext()));
            } else if(i % 3 == 1) {
                list.add(new LineChartItem(generateDataBar(i + 1), getApplicationContext()));
            } else if(i % 3 == 2) {
    ...
    private LineData generateDataLine(int cnt) {
        ...
        LineDataSet d1 = new LineDataSet(values1, "Completed orders " + "" + ", (1)");
        ...
        LineDataSet d2 = new LineDataSet(values2, "Cancelled orders " + "" + ", (2)");
