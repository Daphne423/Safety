...
public class ScreenContactActivity extends AppCompatActivity {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.count() != 5) {
                    ...
                    Toast.makeText(ScreenContactActivity.this, "Can't Add more than 5 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
